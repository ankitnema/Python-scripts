"""
for configuration of weathersearch5.py
usage: python weathersearch5.py --config]
   --config  create or edit configuration file.

for weather map site <Open Weather Map> http://openweathermap.org/.

By: Ankit Nema.
ankitnema1@gmail.com

For the first time:
$ python3 weathersearch4.py --config
1. Add your city ID, then hit enter.  #Mentioned in Assignment document
2. Add your API key, then hit enter.   #Mentioned in Assignment document
3. Type your preferred unit, then hit enter.

Then to check weather data for the same city just need to execute :
$ python weathersearch4.py
...
def send_collected_data_to_display(city_id, user_api, prefer_unit):
    """
...
# ToDo: use argparse library for argv.
# ToDo:
# ToDo:
